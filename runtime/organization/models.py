...
class OrganizationMember(BaseModel):
    ...
    status: MemberStatus = Field(default=MemberStatus.PROPOSED, description="Member allocation status")
...
class OrganizationEvidence(BaseModel):
    ...
    source_stage: str = Field(default="organization_builder", description="Pipeline stage producing evidence")
    asserted_by: str = Field(default="OrganizationBuilder", description="Asserting component")
