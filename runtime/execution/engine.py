...
class WorkflowEngine:
    ...
    def run(self, workflow_id: str) -> ExecutionResult:
        ...
        try:
            steps = DeterministicExecutor(self.events, self.ai_runner).execute(execution_id, plan)
