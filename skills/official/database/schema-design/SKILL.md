---
name: schema-design
description: Translate data models into evolvable structures with enforced integrity. Use when planning or reviewing schema design; do not use as provider-specific implementation guidance.
---
# Schema Design

## Purpose

Translate data models into evolvable structures with enforced integrity.

## Problem Statement

Without a shared decision model, schema design is often driven by habit or defaults, producing inconsistent boundaries and hidden trade-offs.

## When to Use

Use when requirements, architecture, reviews, or change plans require decisions about schema design, before implementation choices become expensive to reverse.
