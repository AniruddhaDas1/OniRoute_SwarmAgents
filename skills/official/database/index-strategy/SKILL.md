---
name: index-strategy
description: Select indexes from workload evidence and maintenance cost. Use when planning or reviewing index strategy; do not use as provider-specific implementation guidance.
---
# Index Strategy

## Purpose

Select indexes from workload evidence and maintenance cost.

## Problem Statement

Without a shared decision model, index strategy is often driven by habit or defaults, producing inconsistent boundaries and hidden trade-offs.

## When to Use

Use when requirements, architecture, reviews, or change plans require decisions about index strategy, before implementation choices become expensive to reverse.
