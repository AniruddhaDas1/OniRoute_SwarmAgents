---
name: transactions
description: Define atomic boundaries and consistency tradeoffs around business invariants. Use when planning or reviewing transactions; do not use as provider-specific implementation guidance.
---
# Transactions

## Purpose

Define atomic boundaries and consistency tradeoffs around business invariants.

## Problem Statement

Without a shared decision model, transactions is often driven by habit or defaults, producing inconsistent boundaries and hidden trade-offs.

## When to Use

Use when requirements, architecture, reviews, or change plans require decisions about transactions, before implementation choices become expensive to reverse.
