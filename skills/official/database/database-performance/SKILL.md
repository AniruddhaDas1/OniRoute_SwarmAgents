...
description: Diagnose and improve database behavior using measured bottlenecks. Use when planning or reviewing database performance; do not use as provider-specific implementation guidance.
---
# Database Performance

## Purpose

Diagnose and improve database behavior using measured bottlenecks.

## Problem Statement

Without a shared decision model, database performance is often driven by habit or defaults, producing inconsistent boundaries and hidden trade-offs.

## When to Use

Use when requirements, architecture, reviews, or change plans require decisions about database performance, before implementation choices become expensive to reverse.
