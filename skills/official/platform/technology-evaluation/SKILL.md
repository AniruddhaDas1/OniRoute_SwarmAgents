...
description: Compare technology fit through requirements, evidence, risk, lifecycle, and portability. Use for planning, evaluation, governance, or review of technology evaluation; do not use as framework-specific or provider-specific implementation guidance.
---
# Technology Evaluation

## Purpose

Compare technology fit through requirements, evidence, risk, lifecycle, and portability.

## Problem Statement

Technology Evaluation decisions often fail when teams optimize one visible concern while leaving ownership, evidence, dependencies, failure behavior, or change cost implicit.
...
- `official.platform.vendor-neutral-architecture`
