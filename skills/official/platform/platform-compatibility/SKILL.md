...
description: Evaluate interoperability and replaceability across platform boundaries. Use for planning, evaluation, governance, or review of platform compatibility; do not use as framework-specific or provider-specific implementation guidance.
---
# Platform Compatibility

## Purpose

Evaluate interoperability and replaceability across platform boundaries.

## Problem Statement

Platform Compatibility decisions often fail when teams optimize one visible concern while leaving ownership, evidence, dependencies, failure behavior, or change cost implicit.
