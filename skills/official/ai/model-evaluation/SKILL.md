...
description: Compare models against task quality, safety, cost, latency, and operational constraints. Use for planning, evaluation, governance, or review of model evaluation; do not use as framework-specific or provider-specific implementation guidance.
---
# Model Evaluation

## Purpose

Compare models against task quality, safety, cost, latency, and operational constraints.

## Problem Statement

Model Evaluation decisions often fail when teams optimize one visible concern while leaving ownership, evidence, dependencies, failure behavior, or change cost implicit.
