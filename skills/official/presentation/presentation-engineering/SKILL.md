...
description: Engineer presentation systems around audience, narrative, evidence, and delivery constraints. Use for planning, evaluation, governance, or review of presentation engineering; do not use as framework-specific or provider-specific implementation guidance.
---
# Presentation Engineering

## Purpose

Engineer presentation systems around audience, narrative, evidence, and delivery constraints.

## Problem Statement

Presentation Engineering decisions often fail when teams optimize one visible concern while leaving ownership, evidence, dependencies, failure behavior, or change cost implicit.
...
- `official.presentation.technical-storytelling`
- `official.presentation.slide-architecture`
- `official.presentation.visual-hierarchy`
