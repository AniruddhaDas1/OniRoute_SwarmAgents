...
description: Design operational and outcome measures with definitions, ownership, and interpretation rules. Use for planning, evaluation, governance, or review of business metrics; do not use as framework-specific or provider-specific implementation guidance.
---
# Business Metrics

## Purpose

Design operational and outcome measures with definitions, ownership, and interpretation rules.

## Problem Statement

Business Metrics decisions often fail when teams optimize one visible concern while leaving ownership, evidence, dependencies, failure behavior, or change cost implicit.
...
- `official.analytics.dashboard-design`
- `official.analytics.kpi-design`
- `official.analytics.data-storytelling`
- `official.analytics.analytical-thinking`
