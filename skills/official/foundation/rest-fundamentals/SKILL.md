...
description: Design resource-oriented HTTP interfaces with clear semantics and boundaries. Use when planning or reviewing rest fundamentals; do not use as provider-specific implementation guidance.
---
# REST Fundamentals

## Purpose

Design resource-oriented HTTP interfaces with clear semantics and boundaries.

## Problem Statement

Without a shared decision model, rest fundamentals is often driven by habit, defaults, or isolated rules. That produces inconsistent boundaries, hidden trade-offs, and weak reviewability.

## When to Use

Use this Skill when requirements, architecture, reviews, or change plans require decisions about rest fundamentals. Apply it before implementation choices become expensive to reverse.
