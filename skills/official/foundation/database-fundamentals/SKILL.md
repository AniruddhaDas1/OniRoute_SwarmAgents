...
description: Select and govern persistence using workload and integrity requirements. Use when planning or reviewing database fundamentals; do not use as provider-specific implementation guidance.
---
# Database Fundamentals

## Purpose

Select and govern persistence using workload and integrity requirements.

## Problem Statement

Without a shared decision model, database fundamentals is often driven by habit, defaults, or isolated rules. That produces inconsistent boundaries, hidden trade-offs, and weak reviewability.

## When to Use

Use this Skill when requirements, architecture, reviews, or change plans require decisions about database fundamentals. Apply it before implementation choices become expensive to reverse.
