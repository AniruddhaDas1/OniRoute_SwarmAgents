---
name: authorization-fundamentals
description: Define access decisions from subjects, resources, actions, and policy. Use when planning or reviewing authorization fundamentals; do not use as provider-specific implementation guidance.
---
# Authorization Fundamentals

## Purpose

Define access decisions from subjects, resources, actions, and policy.

## Problem Statement

Without a shared decision model, authorization fundamentals is often driven by habit, defaults, or isolated rules. That produces inconsistent boundaries, hidden trade-offs, and weak reviewability.

## When to Use

Use this Skill when requirements, architecture, reviews, or change plans require decisions about authorization fundamentals. Apply it before implementation choices become expensive to reverse.
...
- `official.foundation.versioning-fundamentals`
