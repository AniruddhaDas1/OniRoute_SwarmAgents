...
description: Evaluate shared-responsibility cloud capabilities without provider lock-in. Use when planning or reviewing cloud fundamentals; do not use as provider-specific implementation guidance.
---
# Cloud Fundamentals

## Purpose

Evaluate shared-responsibility cloud capabilities without provider lock-in.

## Problem Statement

Without a shared decision model, cloud fundamentals is often driven by habit or defaults, producing inconsistent boundaries and hidden trade-offs.

## When to Use

Use when requirements, architecture, reviews, or change plans require decisions about cloud fundamentals, before implementation choices become expensive to reverse.
