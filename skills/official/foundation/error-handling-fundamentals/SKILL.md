...
description: Design failures as explicit, observable, recoverable contracts. Use when planning or reviewing error handling fundamentals; do not use as provider-specific implementation guidance.
---
# Error Handling Fundamentals

## Purpose

Design failures as explicit, observable, recoverable contracts.

## Problem Statement

Without a shared decision model, error handling fundamentals is often driven by habit, defaults, or isolated rules. That produces inconsistent boundaries, hidden trade-offs, and weak reviewability.

## When to Use

Use this Skill when requirements, architecture, reviews, or change plans require decisions about error handling fundamentals. Apply it before implementation choices become expensive to reverse.
