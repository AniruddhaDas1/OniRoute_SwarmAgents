...
description: Plan clear, traceable, maintainable technical information. Use when planning or reviewing documentation fundamentals; do not use as provider-specific implementation guidance.
---
# Documentation Fundamentals

## Purpose

Plan clear, traceable, maintainable technical information.

## Problem Statement

Without a shared decision model, documentation fundamentals is often driven by habit, defaults, or isolated rules. That produces inconsistent boundaries, hidden trade-offs, and weak reviewability.

## When to Use

Use this Skill when requirements, architecture, reviews, or change plans require decisions about documentation fundamentals. Apply it before implementation choices become expensive to reverse.
