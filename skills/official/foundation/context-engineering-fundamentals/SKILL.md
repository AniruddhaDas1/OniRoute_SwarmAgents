...
description: Select, structure, and govern context for reliable AI behavior. Use when planning or reviewing context engineering fundamentals; do not use as provider-specific implementation guidance.
---
# Context Engineering Fundamentals

## Purpose

Select, structure, and govern context for reliable AI behavior.

## Problem Statement

Without a shared decision model, context engineering fundamentals is often driven by habit or defaults, producing inconsistent boundaries and hidden trade-offs.

## When to Use

Use when requirements, architecture, reviews, or change plans require decisions about context engineering fundamentals, before implementation choices become expensive to reverse.
