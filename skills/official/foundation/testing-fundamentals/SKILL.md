...
description: Build risk-based evidence across behavior and change. Use when planning or reviewing testing fundamentals; do not use as provider-specific implementation guidance.
---
# Testing Fundamentals

## Purpose

Build risk-based evidence across behavior and change.

## Problem Statement

Without a shared decision model, testing fundamentals is often driven by habit, defaults, or isolated rules. That produces inconsistent boundaries, hidden trade-offs, and weak reviewability.

## When to Use

Use this Skill when requirements, architecture, reviews, or change plans require decisions about testing fundamentals. Apply it before implementation choices become expensive to reverse.
