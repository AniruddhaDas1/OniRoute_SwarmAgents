...
description: Reason about relational queries, correctness, and cost. Use when planning or reviewing sql fundamentals; do not use as provider-specific implementation guidance.
---
# SQL Fundamentals

## Purpose

Reason about relational queries, correctness, and cost.

## Problem Statement

Without a shared decision model, sql fundamentals is often driven by habit, defaults, or isolated rules. That produces inconsistent boundaries, hidden trade-offs, and weak reviewability.

## When to Use

Use this Skill when requirements, architecture, reviews, or change plans require decisions about sql fundamentals. Apply it before implementation choices become expensive to reverse.
