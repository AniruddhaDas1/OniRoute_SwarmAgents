...
description: Shape stable interfaces from consumer needs and domain boundaries. Use when planning or reviewing api design fundamentals; do not use as provider-specific implementation guidance.
---
# API Design Fundamentals

## Purpose

Shape stable interfaces from consumer needs and domain boundaries.

## Problem Statement

Without a shared decision model, api design fundamentals is often driven by habit, defaults, or isolated rules. That produces inconsistent boundaries, hidden trade-offs, and weak reviewability.

## When to Use

Use this Skill when requirements, architecture, reviews, or change plans require decisions about api design fundamentals. Apply it before implementation choices become expensive to reverse.
