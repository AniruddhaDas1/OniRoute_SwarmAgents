...
description: Use caching only where consistency, freshness, and invalidation are understood. Use when planning or reviewing caching fundamentals; do not use as provider-specific implementation guidance.
---
# Caching Fundamentals

## Purpose

Use caching only where consistency, freshness, and invalidation are understood.

## Problem Statement

Without a shared decision model, caching fundamentals is often driven by habit, defaults, or isolated rules. That produces inconsistent boundaries, hidden trade-offs, and weak reviewability.

## When to Use

Use this Skill when requirements, architecture, reviews, or change plans require decisions about caching fundamentals. Apply it before implementation choices become expensive to reverse.
