...
description: Design evidence that explains system state and behavior. Use when planning or reviewing observability fundamentals; do not use as provider-specific implementation guidance.
---
# Observability Fundamentals

## Purpose

Design evidence that explains system state and behavior.

## Problem Statement

Without a shared decision model, observability fundamentals is often driven by habit, defaults, or isolated rules. That produces inconsistent boundaries, hidden trade-offs, and weak reviewability.

## When to Use

Use this Skill when requirements, architecture, reviews, or change plans require decisions about observability fundamentals. Apply it before implementation choices become expensive to reverse.
