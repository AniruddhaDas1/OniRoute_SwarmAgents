...
description: Design clear model instructions with explicit context, constraints, and evaluation. Use when planning or reviewing prompt engineering fundamentals; do not use as provider-specific implementation guidance.
---
# Prompt Engineering Fundamentals

## Purpose

Design clear model instructions with explicit context, constraints, and evaluation.

## Problem Statement

Without a shared decision model, prompt engineering fundamentals is often driven by habit or defaults, producing inconsistent boundaries and hidden trade-offs.

## When to Use

Use when requirements, architecture, reviews, or change plans require decisions about prompt engineering fundamentals, before implementation choices become expensive to reverse.
