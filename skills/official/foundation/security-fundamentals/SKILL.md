...
description: Apply risk-based security principles across design decisions. Use when planning or reviewing security fundamentals; do not use as provider-specific implementation guidance.
---
# Security Fundamentals

## Purpose

Apply risk-based security principles across design decisions.

## Problem Statement

Without a shared decision model, security fundamentals is often driven by habit, defaults, or isolated rules. That produces inconsistent boundaries, hidden trade-offs, and weak reviewability.

## When to Use

Use this Skill when requirements, architecture, reviews, or change plans require decisions about security fundamentals. Apply it before implementation choices become expensive to reverse.
