...
description: Create useful event records without leaking secrets or replacing metrics and traces. Use when planning or reviewing logging fundamentals; do not use as provider-specific implementation guidance.
---
# Logging Fundamentals

## Purpose

Create useful event records without leaking secrets or replacing metrics and traces.

## Problem Statement

Without a shared decision model, logging fundamentals is often driven by habit, defaults, or isolated rules. That produces inconsistent boundaries, hidden trade-offs, and weak reviewability.

## When to Use

Use this Skill when requirements, architecture, reviews, or change plans require decisions about logging fundamentals. Apply it before implementation choices become expensive to reverse.
