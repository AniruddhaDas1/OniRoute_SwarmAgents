...
description: Establish identity verification decisions without prescribing a provider. Use when planning or reviewing authentication fundamentals; do not use as provider-specific implementation guidance.
---
# Authentication Fundamentals

## Purpose

Establish identity verification decisions without prescribing a provider.

## Problem Statement

Without a shared decision model, authentication fundamentals is often driven by habit, defaults, or isolated rules. That produces inconsistent boundaries, hidden trade-offs, and weak reviewability.

## When to Use

Use this Skill when requirements, architecture, reviews, or change plans require decisions about authentication fundamentals. Apply it before implementation choices become expensive to reverse.
