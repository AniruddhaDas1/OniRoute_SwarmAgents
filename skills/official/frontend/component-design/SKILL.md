...
description: Design cohesive components with explicit responsibilities and interfaces. Use when planning or reviewing component design; do not use as provider-specific implementation guidance.
---
# Component Design

## Purpose

Design cohesive components with explicit responsibilities and interfaces.

## Problem Statement

Without a shared decision model, component design is often driven by habit or defaults, producing inconsistent boundaries and hidden trade-offs.

## When to Use

Use when requirements, architecture, reviews, or change plans require decisions about component design, before implementation choices become expensive to reverse.
