---
name: accessibility
description: Make interfaces perceivable, operable, understandable, and robust. Use when planning or reviewing accessibility; do not use as provider-specific implementation guidance.
---
# Accessibility

## Purpose

Make interfaces perceivable, operable, understandable, and robust.

## Problem Statement

Without a shared decision model, accessibility is often driven by habit or defaults, producing inconsistent boundaries and hidden trade-offs.

## When to Use

Use when requirements, architecture, reviews, or change plans require decisions about accessibility, before implementation choices become expensive to reverse.
