---
name: ui-patterns
description: Choose familiar interaction patterns while preserving context-specific usability. Use when planning or reviewing ui patterns; do not use as provider-specific implementation guidance.
---
# UI Patterns

## Purpose

Choose familiar interaction patterns while preserving context-specific usability.

## Problem Statement

Without a shared decision model, ui patterns is often driven by habit or defaults, producing inconsistent boundaries and hidden trade-offs.

## When to Use

Use when requirements, architecture, reviews, or change plans require decisions about ui patterns, before implementation choices become expensive to reverse.
