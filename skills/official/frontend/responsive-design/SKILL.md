...
description: Adapt layout and interaction to content, capabilities, and viewport constraints. Use when planning or reviewing responsive design; do not use as provider-specific implementation guidance.
---
# Responsive Design

## Purpose

Adapt layout and interaction to content, capabilities, and viewport constraints.

## Problem Statement

Without a shared decision model, responsive design is often driven by habit or defaults, producing inconsistent boundaries and hidden trade-offs.

## When to Use

Use when requirements, architecture, reviews, or change plans require decisions about responsive design, before implementation choices become expensive to reverse.
