---
name: forms
description: Design input flows, validation, errors, and recovery around user intent. Use when planning or reviewing forms; do not use as provider-specific implementation guidance.
---
# Forms

## Purpose

Design input flows, validation, errors, and recovery around user intent.

## Problem Statement

Without a shared decision model, forms is often driven by habit or defaults, producing inconsistent boundaries and hidden trade-offs.

## When to Use

Use when requirements, architecture, reviews, or change plans require decisions about forms, before implementation choices become expensive to reverse.
