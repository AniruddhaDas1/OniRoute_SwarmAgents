---
name: routing
description: Design navigation, URL state, guards, and recovery as application contracts. Use when planning or reviewing routing; do not use as provider-specific implementation guidance.
---
# Routing

## Purpose

Design navigation, URL state, guards, and recovery as application contracts.

## Problem Statement

Without a shared decision model, routing is often driven by habit or defaults, producing inconsistent boundaries and hidden trade-offs.

## When to Use

Use when requirements, architecture, reviews, or change plans require decisions about routing, before implementation choices become expensive to reverse.
