...
description: Verify client behavior, accessibility, integration, and regression risk. Use when planning or reviewing frontend testing; do not use as provider-specific implementation guidance.
---
# Frontend Testing

## Purpose

Verify client behavior, accessibility, integration, and regression risk.

## Problem Statement

Without a shared decision model, frontend testing is often driven by habit or defaults, producing inconsistent boundaries and hidden trade-offs.

## When to Use

Use when requirements, architecture, reviews, or change plans require decisions about frontend testing, before implementation choices become expensive to reverse.
