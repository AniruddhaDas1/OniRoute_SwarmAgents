...
description: Place state according to ownership, lifetime, synchronization, and consistency. Use when planning or reviewing state management; do not use as provider-specific implementation guidance.
---
# State Management

## Purpose

Place state according to ownership, lifetime, synchronization, and consistency.

## Problem Statement

Without a shared decision model, state management is often driven by habit or defaults, producing inconsistent boundaries and hidden trade-offs.

## When to Use

Use when requirements, architecture, reviews, or change plans require decisions about state management, before implementation choices become expensive to reverse.
