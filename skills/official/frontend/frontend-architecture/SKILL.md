...
description: Structure client systems around stable boundaries and user journeys. Use when planning or reviewing frontend architecture; do not use as provider-specific implementation guidance.
---
# Frontend Architecture

## Purpose

Structure client systems around stable boundaries and user journeys.

## Problem Statement

Without a shared decision model, frontend architecture is often driven by habit or defaults, producing inconsistent boundaries and hidden trade-offs.

## When to Use

Use when requirements, architecture, reviews, or change plans require decisions about frontend architecture, before implementation choices become expensive to reverse.
