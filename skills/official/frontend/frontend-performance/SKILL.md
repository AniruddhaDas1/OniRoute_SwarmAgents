...
description: Manage loading, rendering, interaction, and resource budgets. Use when planning or reviewing frontend performance; do not use as provider-specific implementation guidance.
---
# Frontend Performance

## Purpose

Manage loading, rendering, interaction, and resource budgets.

## Problem Statement

Without a shared decision model, frontend performance is often driven by habit or defaults, producing inconsistent boundaries and hidden trade-offs.

## When to Use

Use when requirements, architecture, reviews, or change plans require decisions about frontend performance, before implementation choices become expensive to reverse.
