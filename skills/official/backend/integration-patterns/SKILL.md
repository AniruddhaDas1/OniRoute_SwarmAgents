...
description: Choose synchronous and asynchronous integration boundaries deliberately. Use when planning or reviewing integration patterns; do not use as provider-specific implementation guidance.
---
# Integration Patterns

## Purpose

Choose synchronous and asynchronous integration boundaries deliberately.

## Problem Statement

Without a shared decision model, integration patterns is often driven by habit or defaults, producing inconsistent boundaries and hidden trade-offs.

## When to Use

Use when requirements, architecture, reviews, or change plans require decisions about integration patterns, before implementation choices become expensive to reverse.
