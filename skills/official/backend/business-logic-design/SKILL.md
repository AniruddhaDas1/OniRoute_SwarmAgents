...
description: Model domain rules independently from transport, persistence, and providers. Use when planning or reviewing business logic design; do not use as provider-specific implementation guidance.
---
# Business Logic Design

## Purpose

Model domain rules independently from transport, persistence, and providers.

## Problem Statement

Without a shared decision model, business logic design is often driven by habit or defaults, producing inconsistent boundaries and hidden trade-offs.

## When to Use

Use when requirements, architecture, reviews, or change plans require decisions about business logic design, before implementation choices become expensive to reverse.
