...
description: Contain failure through timeouts, isolation, retry discipline, and graceful degradation. Use when planning or reviewing resilience patterns; do not use as provider-specific implementation guidance.
---
# Resilience Patterns

## Purpose

Contain failure through timeouts, isolation, retry discipline, and graceful degradation.

## Problem Statement

Without a shared decision model, resilience patterns is often driven by habit or defaults, producing inconsistent boundaries and hidden trade-offs.

## When to Use

Use when requirements, architecture, reviews, or change plans require decisions about resilience patterns, before implementation choices become expensive to reverse.
