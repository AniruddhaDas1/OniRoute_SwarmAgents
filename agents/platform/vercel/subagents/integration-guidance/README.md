# Vercel Integration Guidance Agent

## Overview

The Vercel Integration Guidance Agent is a capability-oriented Platform sub-agent focused on integration guidance.
...
- Own Vercel integration guidance.
...
- Vercel integration guidance findings.
