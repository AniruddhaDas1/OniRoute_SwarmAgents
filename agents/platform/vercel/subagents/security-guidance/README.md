# Vercel Security Guidance Agent

## Overview

The Vercel Security Guidance Agent is a capability-oriented Platform sub-agent focused on security guidance.
...
- Vercel security guidance findings.
