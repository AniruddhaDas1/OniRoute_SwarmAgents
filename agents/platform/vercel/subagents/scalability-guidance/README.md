# Vercel Scalability Guidance Agent

## Overview

The Vercel Scalability Guidance Agent is a capability-oriented Platform sub-agent focused on scalability guidance.
...
- Own Vercel scalability guidance.
...
- Vercel capability evidence, constraints, and workload needs.

## Outputs

- Vercel scalability guidance findings.
...
The other capability-oriented sub-agents under the Vercel Agent.
