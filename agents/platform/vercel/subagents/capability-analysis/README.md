# Vercel Capability Analysis Agent

## Overview

The Vercel Capability Analysis Agent is a capability-oriented Platform sub-agent focused on capability analysis.
...
- Own Vercel capability analysis.
...
- Vercel capability analysis findings.
