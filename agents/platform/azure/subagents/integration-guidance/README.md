# Azure Integration Guidance Agent

## Overview

The Azure Integration Guidance Agent is a capability-oriented Platform sub-agent focused on integration guidance.
...
- Azure integration guidance findings.
