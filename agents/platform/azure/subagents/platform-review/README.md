# Azure Platform Review Agent

## Overview

The Azure Platform Review Agent is a capability-oriented Platform sub-agent focused on platform review.
...
- Azure platform review findings.
