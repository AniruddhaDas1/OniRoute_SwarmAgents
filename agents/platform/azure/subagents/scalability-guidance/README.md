# Azure Scalability Guidance Agent

## Overview

The Azure Scalability Guidance Agent is a capability-oriented Platform sub-agent focused on scalability guidance.
...
- Azure scalability guidance findings.
