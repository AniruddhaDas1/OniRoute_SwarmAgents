# Azure Compatibility Agent

## Overview

The Azure Compatibility Agent is a capability-oriented Platform sub-agent focused on compatibility assessment.
...
- Azure compatibility assessment findings.
