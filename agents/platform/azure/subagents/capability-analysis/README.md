# Azure Capability Analysis Agent

## Overview

The Azure Capability Analysis Agent is a capability-oriented Platform sub-agent focused on capability analysis.
...
- Azure capability analysis findings.
