# Azure Operational Guidance Agent

## Overview

The Azure Operational Guidance Agent is a capability-oriented Platform sub-agent focused on operational guidance.
...
- Azure operational guidance findings.
