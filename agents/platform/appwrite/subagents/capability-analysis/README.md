# Appwrite Capability Analysis Agent

## Overview

The Appwrite Capability Analysis Agent is a capability-oriented Platform sub-agent focused on capability analysis.
...
- Own Appwrite capability analysis.
...
- Appwrite capability analysis findings.
