# Appwrite Compatibility Agent

## Overview

The Appwrite Compatibility Agent is a capability-oriented Platform sub-agent focused on compatibility assessment.
...
- Own Appwrite compatibility assessment.
...
- Appwrite compatibility assessment findings.
