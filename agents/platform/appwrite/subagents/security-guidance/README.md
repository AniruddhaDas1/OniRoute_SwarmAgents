# Appwrite Security Guidance Agent

## Overview

The Appwrite Security Guidance Agent is a capability-oriented Platform sub-agent focused on security guidance.
...
- Own Appwrite security guidance.
...
- Appwrite security guidance findings.
