# Appwrite Platform Review Agent

## Overview

The Appwrite Platform Review Agent is a capability-oriented Platform sub-agent focused on platform review.
...
- Appwrite platform review findings.
