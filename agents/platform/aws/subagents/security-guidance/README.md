# AWS Security Guidance Agent

## Overview

The AWS Security Guidance Agent is a capability-oriented Platform sub-agent focused on security guidance.
...
- AWS security guidance findings.
