# Firebase Platform Review Agent

## Overview

The Firebase Platform Review Agent is a capability-oriented Platform sub-agent focused on platform review.
...
- Firebase platform review findings.
