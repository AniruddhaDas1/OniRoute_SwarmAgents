# Firebase Migration Guidance Agent

## Overview

The Firebase Migration Guidance Agent is a capability-oriented Platform sub-agent focused on migration guidance.
...
- Own Firebase migration guidance.
...
- Firebase migration guidance findings.
