# Firebase Compatibility Agent

## Overview

The Firebase Compatibility Agent is a capability-oriented Platform sub-agent focused on compatibility assessment.
...
- Own Firebase compatibility assessment.
...
- Firebase compatibility assessment findings.
