# Firebase Security Guidance Agent

## Overview

The Firebase Security Guidance Agent is a capability-oriented Platform sub-agent focused on security guidance.
...
- Own Firebase security guidance.
...
- Firebase security guidance findings.
