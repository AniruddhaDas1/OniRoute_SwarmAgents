# Firebase Capability Analysis Agent

## Overview

The Firebase Capability Analysis Agent is a capability-oriented Platform sub-agent focused on capability analysis.
...
- Own Firebase capability analysis.
...
- Firebase capability analysis findings.
