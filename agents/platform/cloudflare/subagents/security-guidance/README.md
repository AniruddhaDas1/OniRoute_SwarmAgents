# Cloudflare Security Guidance Agent

## Overview

The Cloudflare Security Guidance Agent is a capability-oriented Platform sub-agent focused on security guidance.
...
- Own Cloudflare security guidance.
...
- Cloudflare security guidance findings.
