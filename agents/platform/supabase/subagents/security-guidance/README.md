# Supabase Security Guidance Agent

## Overview

The Supabase Security Guidance Agent is a capability-oriented Platform sub-agent focused on security guidance.
...
- Own Supabase security guidance.
...
- Supabase security guidance findings.
