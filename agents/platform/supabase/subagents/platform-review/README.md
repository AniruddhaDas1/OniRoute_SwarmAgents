# Supabase Platform Review Agent

## Overview

The Supabase Platform Review Agent is a capability-oriented Platform sub-agent focused on platform review.
...
- Supabase platform review findings.
