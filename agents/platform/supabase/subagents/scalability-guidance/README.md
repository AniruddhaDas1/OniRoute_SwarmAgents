# Supabase Scalability Guidance Agent

## Overview

The Supabase Scalability Guidance Agent is a capability-oriented Platform sub-agent focused on scalability guidance.
...
- Own Supabase scalability guidance.
...
- Supabase capability evidence, constraints, and workload needs.

## Outputs

- Supabase scalability guidance findings.
...
The other capability-oriented sub-agents under the Supabase Agent.
