# Supabase Compatibility Agent

## Overview

The Supabase Compatibility Agent is a capability-oriented Platform sub-agent focused on compatibility assessment.
...
- Own Supabase compatibility assessment.
...
- Supabase compatibility assessment findings.
