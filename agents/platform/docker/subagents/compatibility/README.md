# Docker Compatibility Agent

## Overview

The Docker Compatibility Agent is a capability-oriented Platform sub-agent focused on compatibility assessment.
...
- Own Docker compatibility assessment.
...
- Docker compatibility assessment findings.
