# Docker Scalability Guidance Agent

## Overview

The Docker Scalability Guidance Agent is a capability-oriented Platform sub-agent focused on scalability guidance.
...
- Own Docker scalability guidance.
...
- Docker capability evidence, constraints, and workload needs.

## Outputs

- Docker scalability guidance findings.
...
The other capability-oriented sub-agents under the Docker Agent.
