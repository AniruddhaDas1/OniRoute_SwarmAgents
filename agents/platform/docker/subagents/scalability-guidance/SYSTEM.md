# Docker Scalability Guidance Agent System Contract
...
- Escalate ambiguity or cross-domain conflicts to the Docker Agent.
...
- Receive direction from the Docker Agent.
- Collaborate with sibling capability sub-agents when concerns intersect.
- Escalate work outside this responsibility to the Docker Agent.
