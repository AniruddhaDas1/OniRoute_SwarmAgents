# Docker Security Guidance Agent

## Overview

The Docker Security Guidance Agent is a capability-oriented Platform sub-agent focused on security guidance.
...
- Docker security guidance findings.
