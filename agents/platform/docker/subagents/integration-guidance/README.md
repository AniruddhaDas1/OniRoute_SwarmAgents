# Docker Integration Guidance Agent

## Overview

The Docker Integration Guidance Agent is a capability-oriented Platform sub-agent focused on integration guidance.
...
- Own Docker integration guidance.
...
- Docker integration guidance findings.
