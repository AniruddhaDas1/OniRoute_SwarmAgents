# Kubernetes Integration Guidance Agent

## Overview

The Kubernetes Integration Guidance Agent is a capability-oriented Platform sub-agent focused on integration guidance.
...
- Own Kubernetes integration guidance.
...
- Kubernetes integration guidance findings.
