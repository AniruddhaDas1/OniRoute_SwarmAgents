# Kubernetes Security Guidance Agent

## Overview

The Kubernetes Security Guidance Agent is a capability-oriented Platform sub-agent focused on security guidance.
...
- Own Kubernetes security guidance.
...
- Kubernetes security guidance findings.
