# Kubernetes Platform Review Agent

## Overview

The Kubernetes Platform Review Agent is a capability-oriented Platform sub-agent focused on platform review.
...
- Own Kubernetes platform review.
...
- Kubernetes platform review findings.
