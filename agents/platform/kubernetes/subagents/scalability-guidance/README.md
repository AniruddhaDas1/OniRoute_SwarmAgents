# Kubernetes Scalability Guidance Agent

## Overview

The Kubernetes Scalability Guidance Agent is a capability-oriented Platform sub-agent focused on scalability guidance.
...
- Own Kubernetes scalability guidance.
...
- Kubernetes capability evidence, constraints, and workload needs.

## Outputs

- Kubernetes scalability guidance findings.
...
The other capability-oriented sub-agents under the Kubernetes Agent.
