# Kubernetes Migration Guidance Agent

## Overview

The Kubernetes Migration Guidance Agent is a capability-oriented Platform sub-agent focused on migration guidance.
...
- Own Kubernetes migration guidance.
...
- Kubernetes migration guidance findings.
