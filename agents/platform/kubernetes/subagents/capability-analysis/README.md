# Kubernetes Capability Analysis Agent

## Overview

The Kubernetes Capability Analysis Agent is a capability-oriented Platform sub-agent focused on capability analysis.
...
- Own Kubernetes capability analysis.
...
- Kubernetes capability analysis findings.
