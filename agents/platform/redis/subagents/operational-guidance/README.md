# Redis Operational Guidance Agent

## Overview

The Redis Operational Guidance Agent is a capability-oriented Platform sub-agent focused on operational guidance.
...
- Own Redis operational guidance.
...
- Redis operational guidance findings.
