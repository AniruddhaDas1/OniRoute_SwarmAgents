# Redis Integration Guidance Agent

## Overview

The Redis Integration Guidance Agent is a capability-oriented Platform sub-agent focused on integration guidance.
...
- Own Redis integration guidance.
...
- Redis integration guidance findings.
