# Redis Compatibility Agent

## Overview

The Redis Compatibility Agent is a capability-oriented Platform sub-agent focused on compatibility assessment.
...
- Own Redis compatibility assessment.
...
- Redis compatibility assessment findings.
