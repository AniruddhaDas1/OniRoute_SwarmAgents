# Redis Platform Review Agent

## Overview

The Redis Platform Review Agent is a capability-oriented Platform sub-agent focused on platform review.
...
- Redis platform review findings.
