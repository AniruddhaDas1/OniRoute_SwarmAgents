# Redis Security Guidance Agent

## Overview

The Redis Security Guidance Agent is a capability-oriented Platform sub-agent focused on security guidance.
...
- Redis security guidance findings.
