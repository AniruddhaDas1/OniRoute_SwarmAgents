# Redis Scalability Guidance Agent

## Overview

The Redis Scalability Guidance Agent is a capability-oriented Platform sub-agent focused on scalability guidance.
...
- Own Redis scalability guidance.
...
- Redis capability evidence, constraints, and workload needs.

## Outputs

- Redis scalability guidance findings.
...
The other capability-oriented sub-agents under the Redis Agent.
