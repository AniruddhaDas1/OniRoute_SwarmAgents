# Google Cloud Operational Guidance Agent

## Overview

The Google Cloud Operational Guidance Agent is a capability-oriented Platform sub-agent focused on operational guidance.
...
- Google Cloud operational guidance findings.
