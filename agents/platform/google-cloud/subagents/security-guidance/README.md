# Google Cloud Security Guidance Agent

## Overview

The Google Cloud Security Guidance Agent is a capability-oriented Platform sub-agent focused on security guidance.
...
- Own Google Cloud security guidance.
...
- Google Cloud security guidance findings.
