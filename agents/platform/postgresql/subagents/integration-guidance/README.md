# PostgreSQL Integration Guidance Agent

## Overview

The PostgreSQL Integration Guidance Agent is a capability-oriented Platform sub-agent focused on integration guidance.
...
- Own PostgreSQL integration guidance.
...
- PostgreSQL integration guidance findings.
