# PostgreSQL Scalability Guidance Agent

## Overview

The PostgreSQL Scalability Guidance Agent is a capability-oriented Platform sub-agent focused on scalability guidance.
...
- Own PostgreSQL scalability guidance.
...
- PostgreSQL capability evidence, constraints, and workload needs.

## Outputs

- PostgreSQL scalability guidance findings.
...
The other capability-oriented sub-agents under the PostgreSQL Agent.
