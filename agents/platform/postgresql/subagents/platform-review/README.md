# PostgreSQL Platform Review Agent

## Overview

The PostgreSQL Platform Review Agent is a capability-oriented Platform sub-agent focused on platform review.
...
- Own PostgreSQL platform review.
...
- PostgreSQL platform review findings.
