# PostgreSQL Security Guidance Agent

## Overview

The PostgreSQL Security Guidance Agent is a capability-oriented Platform sub-agent focused on security guidance.
...
- Own PostgreSQL security guidance.
...
- PostgreSQL security guidance findings.
