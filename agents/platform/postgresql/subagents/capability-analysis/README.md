# PostgreSQL Capability Analysis Agent

## Overview

The PostgreSQL Capability Analysis Agent is a capability-oriented Platform sub-agent focused on capability analysis.
...
- Own PostgreSQL capability analysis.
...
- PostgreSQL capability analysis findings.
