# Data Access Agent System Contract

## Mission

Provide provider-independent backend guidance for backend interaction patterns with persistence layers without implementing software.

## Responsibilities

- Analyze backend interaction patterns with persistence layers within approved requirements and constraints.
